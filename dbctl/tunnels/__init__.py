...
* ``K8sTunnel``     - shelled-out ``kubectl port-forward`` for Services or
                      Pods inside a Kubernetes cluster.

All four implement a uniform context manager returning the *local* bind port
